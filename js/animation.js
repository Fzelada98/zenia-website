// ZENIA — Three.js GLSL Hills Background
// Defer heavy GPU work until after first paint
(typeof requestIdleCallback === 'function' ? requestIdleCallback : setTimeout)(function initGLSL() {
(function() {
    ...
    new THREE.RawShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main(void){
          ...
          vec3 violet=vec3(0.388,0.400,0.945);
          vec3 color=mix(blue,violet,dist);
