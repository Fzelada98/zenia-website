...
VERTICALS = [
    ...
    },
    {
        ...
        "content_blocks": [
            ...
            {"icon": "clock", "h2_main": "Reservas directas:", "h2_gradient": "tu canal mas rentable", "text": "Cuando un cliente potencial te escribe por WhatsApp preguntando disponibilidad, tienes 30 minutos para responder. Despues, reserva en Booking. Tu agente de IA responde al instante con habitaciones disponibles, precios y fotos. Cierra la reserva directa sin comisiones."},
...
<section class="section" id="precios">
  <div class="container">
    ...
    <div class="services-grid" style="grid-template-columns:repeat(3,1fr);margin-top:48px">
      ...
      <div class="service-card" style="text-align:center">
        <h3>Enterprise</h3>
        <div class="impact-number text-gradient" style="margin:16px 0 8px">A medida</div>
